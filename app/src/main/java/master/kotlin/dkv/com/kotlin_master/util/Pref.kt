package master.kotlin.dkv.com.kotlin_master.util
...
open class Pref<T>(private val key: String, private val default: T, private val name: String? = null): ReadWriteProperty<Any?, T> {
    @Suppress("UNCHECKED_CAST")
    override fun getValue(thisRef: Any?, property: KProperty<*>): T {
        var pref = context.getSharedPreferences(name ?:  prefName, prefMode)
    ...
    override fun setValue(thisRef: Any?, property: KProperty<*>, value: T) {
        var editor: SharedPreferences.Editor = context.getSharedPreferences(name ?: prefName, prefMode).edit()
